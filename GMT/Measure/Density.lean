...
-- Simon, Chapter 1, Section 2, p. 9; used in Chapter 4, formula (3.9): omega_n.
...
-- Simon, Chapter 1, Theorem 2.9, pp. 11-13: the normalized Euclidean ball formula.
...
-- Simon, Chapter 1, formula (3.1), p. 13, with A = X: the lower radial density.
def lowerDensity (μ : Measure E) (n : ℕ) (x : E) : ℝ≥0∞ :=
  liminf (densityRatio μ n x) (𝓝[>] 0)

-- Simon, Chapter 1, formula (3.1), p. 13, with A = X: the upper radial density.
